...
import (
	...
	"github.com/kaiserkarel/drfs/restic/restic/lib/checker"
	...
	restictest "github.com/kaiserkarel/drfs/restic/restic/lib/test"
...
func TestMetadataChanged(t *testing.T) {
	...
	// See https://github.com/kaiserkarel/drfs/restic/restic/issues/2372
	node3.User = ""
	node3.Group = ""
