...
[project page](https://github.com/kaiserkarel/drfs/restic/restic)) for all related discussions
as well as the `#restic` channel on `irc.freenode.net`.

If you want to find an area that currently needs improving have a look at the
open issues listed at the
[issues page](https://github.com/kaiserkarel/drfs/restic/restic/issues). This is also the place
for discussing enhancement to the restic tools.

If you are unsure what to do, please have a look at the issues, especially
those tagged
[minor complexity](https://github.com/kaiserkarel/drfs/restic/restic/labels/minor%20complexity).
...
`$GOPATH` set) and `cd` into the directory:
    ...
    $ unset GOPATH
    $ git clone https://github.com/kaiserkarel/drfs/restic/restic
    $ cd restic
