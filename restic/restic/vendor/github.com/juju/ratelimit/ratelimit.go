...
// takeAvailable is the lib version of TakeAvailable - it takes the
...
// available is the lib version of available - it takes the current time as
...
// take is the lib version of Take - it takes the current time as
// an argument to enable easy testing.
