...
type Connection struct {
	...
	Internal                    bool              // Set this to true to use the the lib / service network
...
//
// Other
//     OS_ENDPOINT_TYPE - Endpoint type public, lib or admin
...
//     GOSWIFT_INTERNAL - Set this to "true" to use the the lib network (obsolete - use OS_ENDPOINT_TYPE)
