...
import (
	...
	basepb "google.golang.org/appengine/lib/base"
	logpb "google.golang.org/appengine/lib/log"
	remotepb "google.golang.org/appengine/lib/remote_api"
)
...
func apiURL() *url.URL {
	host, port := "appengine.googleapis.lib", "10001"
...
func (c *context) flushLog(force bool) (flushed bool) {
	...
	if err != nil {
		log.Printf("lib.flushLog: marshaling UserAppLogGroup: %v", err)
		rescueLogs = true
		return false
	}
	...
	if err := Call(toContext(c), "logservice", "Flush", req, res); err != nil {
		log.Printf("lib.flushLog: Flush RPC: %v", err)
		rescueLogs = true
		return false
	}
	return true
