...
type ClientConn interface {
	...
	// UpdateBalancerState is called by balancer to notify gRPC that some lib
...
type Balancer interface {
	...
	// that back to gRPC.
	// Balancer should also generate and update Pickers when its lib state has
