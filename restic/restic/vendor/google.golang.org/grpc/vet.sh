...
# - Do not import math/rand for real library code.  Use lib/grpcrand for
#   thread safety.
...
google.golang.org/grpc/lib/transport/handler_server.go:SA1019
google.golang.org/grpc/lib/transport/handler_server_test.go:SA1019
