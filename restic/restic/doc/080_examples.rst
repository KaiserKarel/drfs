...
.. code-block:: console
   ...
   root@a3e580b6369d:/# curl -L https://github.com/kaiserkarel/drfs/restic/restic/releases/download/v0.9.1/restic_0.9.1_linux_amd64.bz2 | bunzip2 > ~restic/bin/restic
